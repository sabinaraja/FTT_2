...
function intructions_4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of intructions_4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function memorability_facesRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of memorability_facesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function memorabilityRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of memorabilityComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
